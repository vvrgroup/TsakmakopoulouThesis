...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True):
        ...
        """
        self.async_flag = False
        self.async_overhead = 100  # ms constant in 'sim' a number between a range of min and max in 'real'
        self.async_mode = 'sim'
        self.loc_err_flag = True
        self.xyz_noise_std = 0.3
        self.ryp_noise_std = 0.3
        self.data_size = 0  # Mb (Megabits) #only for real mode
        self.transmission_speed = 27  # Mbps
        self.backbone_delay = 0  # ms       
        self.seed = 25
        """
